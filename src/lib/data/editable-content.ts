...
export const EDITABLE: Record<string, EditableDef> = {
  ...
  // ===== Sobre =====
  "sobre.meta.title": { page: "/sobre", pageLabel: "Sobre", section: "SEO", label: "Meta title", type: "text", default: "Sobre Nós" },
  "sobre.meta.description": { page: "/sobre", pageLabel: "Sobre", section: "SEO", label: "Meta description", type: "multiline", default: "Conheça quem está por trás do Papo de Bola, portal independente de futebol e esportes desde 2004, com notícias, placares e classificações." },
  "sobre.h1": { page: "/sobre", pageLabel: "Sobre", section: "Conteúdo", label: "Título principal (H1)", type: "text", default: "Sobre Nós" },
  ...
  "sobre.producao.p2": { page: "/sobre", pageLabel: "Sobre", section: "Como produzimos", label: "Texto 2", type: "multiline", default: "Quando um conteúdo é corrigido ou atualizado, fazemos isso de forma transparente. Se você encontrar alguma informação imprecisa, fale com a gente, levamos isso a sério." },
